...
import 'package:RMart/Pages/Cart/CartHolder.dart';
...
class HelperWidgets {
  static Widget getHeader(context, heading, callBack,
                                  ...
                                  child: Stack(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Icon(Entypo.shopping_cart,
                                            size: 25),
                                      ),
                                    ],
                                  ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            showStoreName
                                ? Text(
                                    "from ${ProductContext.getOwnerName(object.productOwner)}",
                                    style: TextStyle(
                                        fontSize: 10,
                                        fontWeight: FontWeight.w600,
                                        fontFamily: AppFonts.textFonts,
                              ...
                              child: Row(
                                ...
                                children: [
                                  object.discount == 0
                                      ? Center()
                                      : Text(
                                          "Rs ${object.price + object.discount}",
                                          style: TextStyle(
                                              fontSize: 15,
                                              color: Colors.grey,
                                              decoration:
