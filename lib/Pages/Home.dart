          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: List.generate(ProductContext.merchants.length, (index) {
                    print("Merchant = " +
                        ProductContext.data[ProductContext.merchants[index]]
                            .toString());
                    return merchantTile(
                        ProductContext.getOwnerName(
                          ProductContext.merchants[index],
                        ),
                        ProductContext.data[ProductContext.merchants[index]],
                        ProductContext.merchants[index]);
                  }) +
          ...
          child: Container(
            ...
            child: Padding(
              padding: const EdgeInsets.only(
                  left: 15.0, top: 15, bottom: 10, right: 10),
              child: Column(
          ...
          Column(
            ...
            children: [
              ...
              GestureDetector(
                  ...
                  child: Image(
                    image:
                        Image.asset("lib/assets/Images/ham_burger.png").image,
                    height: 25,
                  )),
              SizedBox(height: 15),
              Text(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(
                            top: 28.0, bottom: 28, left: 20, right: 20),
                        child: Container(
                            color: AppColors.backgroundColor,
                            height: 90,
                            child: ClipRRect(
                                ...
                                child: Image(
                                    image: Image.asset(
                                            "lib/assets/Images/Categories/$heading.png")
                                        .image)
                                // child: Image(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                                width: 130,
                                child: Text(
                                  ProductsApi.categoryTime[heading],
                                  style: TextStyle(
                                      fontSize: 10,
                                      fontFamily: AppFonts.textFonts,
                                      fontWeight: FontWeight.w500,
