...
class _CartState extends State<Cart> {
  ...
  Widget checkOutSheet() {
    return Consumer<CartListModel>(
      builder: (context, cart, _) {
        ...
        return CartListModel.cartProductMap.isEmpty
            ? Center()
            : Material(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        left: 20.0,
                        right: 20,
                        bottom: widget.isFromCartHolder ? 0 : 65),
                    child: Row(
      ...
      child: Center(
        ...
        children: [
          Padding(
            ...
            child: Image(
              image: Image.asset("lib/assets/Images/cart2.png").image,
          ...
          Text(
            "Make your basket happy by",
            style: TextStyle(
                fontFamily: AppFonts.textFonts,
                fontWeight: FontWeight.w600,
                color: Colors.grey),
          ),
          Text("adding foods to it",
              style: TextStyle(
                  fontFamily: AppFonts.textFonts,
                  fontWeight: FontWeight.w600,
                  color: Colors.grey))
  ...
  Widget getHeader(context, heading, callBack, {showShoppingCart = false}) {
    return Consumer<CartListModel>(builder: (context, cart, _) {
      return Material(
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
              "All the items in the cart will be removed. Are you sure you want to delete the cart?"),
          actions: <Widget>[
            FlatButton(
              onPressed: () {
