...
class _ExploreState extends State<Explore> {
  ...
  var categories = ProductContext.categories.sublist(1,ProductContext.categories.length);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Top of",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600,fontFamily: AppFonts.textFonts),),
                      Row(
                        children: [
                          Text("the day",style: TextStyle(fontSize: 30,fontWeight: FontWeight.w600,fontFamily: AppFonts.textFonts),),
                          SizedBox(width: 20,),
                          Icon(MaterialCommunityIcons.food_fork_drink,size: 40,)
                        ],
                      ),
                    ],
                  ),
                      ...
                      children: [
                        ...
                        Material(
                          ...
                          child: Container(height: 30,width: 70,
                            child: Center(
                              child: Text("${products.length} Items",style: TextStyle(color: AppColors.backgroundColor,fontSize: 10,fontWeight: FontWeight.w600),),
                            ),
                          ),
                        ),
                      ],
