...
class _ProductDetailsState extends State<ProductDetails> {
      ...
      body: SafeArea(
        child: Stack(
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    HelperWidgets.getHeader(
                        ...
                        showShoppingCart: true), //simpleAppBar(),
                    Container(
                      height: (MediaQuery.of(context).size.height - 300) * 0.5,
                      child: CachedNetworkImage(
                        height:
                            (MediaQuery.of(context).size.height - 300) * 0.5,
                        width: (MediaQuery.of(context).size.width) * 0.7,
                        imageUrl: widget.product.imageURL,
                        placeholder: (context, url) =>
                            Image.asset("lib/assets/Images/image_loading.png"),
            ...
            Column(
              children: [Expanded(child: Container()), bottomSheet()],
            )
          ],
        ),
      ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "From ${ProductContext.getOwnerName(widget.product.productOwner)}",
                                style: TextStyle(
                                    fontSize: 12,
                                    color: Colors.grey,
                                    fontFamily: AppFonts.textFonts),
                                ...
                                Consumer<CartListModel>(
                                  builder: (context, cart, _) => IconButton(
                                    ...
                                    icon: Icon(
                                      ...
                                      size: 22.5,
                                      color: Colors.grey,
                                    ), //Image(image: Image.asset("lib/assets/Images/order_now_logo.png").image,height: 30),
                                    onPressed: () async {
                                      if (await HelperFunctions.isSameCategory(
                                          context,
                                          cart,
                                          widget.product,
                                          count)) {
                                        ...
                                        AlertHelper.showSuccessSnackBar(
  ...
  Widget getSuggestions() {
    var suggestions = ProductContext.data[widget.product.productOwner]
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              ...
              children: List.generate(suggestions.length, (index) {
                    ...
                    var product = productMap is Product
                        ? productMap
                        : Product(
                            ...
                            widget.product.category,
                            productMap["discount"]);
                    return product.productName != widget.product.productName
                        ? suggestionTile(product)
                        : Center();
                  }) +
                  [
                    SizedBox(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Icon(AntDesign.minus,
                            color: AppColors.iconColor, size: 18),
                      ),
                      Text(
                        count.toString(),
                        style: TextStyle(
                  ...
                  child: Row(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                            color: Colors.transparent, height: 40, width: 60),
                      ),
                      GestureDetector(
                        onTap: () {
                          setState(() {
